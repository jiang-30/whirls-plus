 ...
 */
export function useTableAttrsFormatter(option: any, defaultConfig: ITableAttrs = {}): ITableAttrs {
 ...
 * table fields 表格项信息
 */
export function useTableFieldsFormatter(fields: any[], defaultConfig: ITableColumnAttrs = {}): any[] {
