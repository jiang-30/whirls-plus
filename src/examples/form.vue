<template>
  <WFormSearch :option="option" :formModel="formModel"></WFormSearch>
  <WForm :option="option" :formModel="formModel"></WForm>
</template>

<script setup lang="ts">
import { ref } from "vue";
import { WForm, WFormSearch } from "@/packages/components/src/index";
